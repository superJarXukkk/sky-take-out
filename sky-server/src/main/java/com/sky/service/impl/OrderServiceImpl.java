...
//        }
    ...
    public OrderVO getDetailByid(Long id) {
        ...
        List<OrderDetail> orderDetails = orderDetailMapper.getDetailsByOrderId(id);
    ...
    @Override
    public PageResult getHistoryOrders(int page, int pageSize, int status) {
        PageHelper.startPage(page,pageSize);

        Page<OrderVO> pages = orderMapper.getAllPreDetail(
                Orders.builder().status(status).userId(BaseContext.getCurrentId()).build());
    ...
    public void cancelOrder(Long id) {
        orderMapper.update(Orders.builder().status(Orders.CANCELLED).id(id).build());
    }
    ...
    public OrderVO details(Long id) {
        ...
        // 查询该订单对应的菜品/套餐明细
        List<OrderDetail> orderDetailList = orderDetailMapper.getDetailsByOrderId(orders.getId());
    ...
    public PageResult conditionSearch(OrdersPageQueryDTO ordersPageQueryDTO) {
        ...
        Page<OrderVO> page = orderMapper.getAllPreDetail(Orders.builder().status(ordersPageQueryDTO.getStatus()).build());
